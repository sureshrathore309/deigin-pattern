package com.apisero.singleton;
/*
 * Singleton pattern is one of the simplest design patterns in Java. 
 * This type of design pattern comes under creational pattern as this pattern provides one of 
 * the best ways to create an object. This pattern involves a single class which is responsible 
 * to create an object while making sure that only single object gets created. This class 
